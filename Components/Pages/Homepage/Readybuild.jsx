        ...
        <section className='bg-[#4F0FBD]'>
            <div className="container">
                <div className="border-x border-[rgba(255,255,255,0.12)] padding-80 px-5 lg:px-10 flex flex-col gap-10 lg:flex-row">
                    <div className="lg:max-w-[554px] my-auto">
                        ...
                        <div className="mt-10 flex flex-col md:flex-row gap-4">
                            <Link href={'/contact-us'} className='primary-btn large w-fit'>Schedule a Discovery Call</Link>
                            <Link href={'/'} className='outline-btn large !text-white w-fit'>View Pricing</Link>
                        </div>
                    </div>
                    <div>
                        <Image src={Buildscale} alt='JumboTiger platform preview' loading='lazy' className='w-full' />
